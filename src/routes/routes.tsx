...
export const routes: AppRoute[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'register', element: <SecurityBoardRegister />, label: 'Register Security Board' },
    ],
  },
 {
    path: '/violation',
    ...
    children: [
      ...
      { path: 'register', element: <RegisterViolation />, label: 'Register Violation' },
  ...
  },
  {
    ...
    isPrivate: true,
    children: [
      { path: 'user-management', element: <UserManagement />, label: 'User Management' },
      { path: 'organization', element: <Organization />, label: 'Organization' },
      { path: 'role-management', element: <RoleManagement />, label: 'Role Management' },
      { path: 'account-management', element: <AccountManagement />, label: 'Account Management' },
    ],
  },
